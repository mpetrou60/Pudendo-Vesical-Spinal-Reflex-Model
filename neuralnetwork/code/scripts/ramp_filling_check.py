...
import pathlib
import os
sys.path.append('/data/mnp34/scs_model-main/step_3/neuralnetwork/code')
from tools import seed_handler as sh

sh.set_seed()
sys.path.append('/data/mnp34/scs_model-main/step_3/neuralnetwork/nnStructures')
...
def main():
    ...
    bp_mean[freq] = []
    # directory name
    dir_name = "final/" + str(freq) + '/' +  str(pud) + '-' + str(pel)+'/'
    ...
    try:
        ...
        res_file = open('/data/mnp34/scs_model-main/step_3/results/' + dir_name + "%.1f pud-%.1f pel at %.1f.txt" % (pud, pel, freq),'wt')
