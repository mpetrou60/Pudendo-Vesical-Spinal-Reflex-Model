	...
	def _load_rec_data(self):
		...
		if rank==0:
			if self._species=='cat':
				recI_MG = np.loadtxt('/data/mnp34/scs_model-main/step_3/inputs/PudAff.txt')
				recII_MG = np.loadtxt('/data/mnp34/scs_model-main/step_3/inputs/PelAff.txt')
				recMn_MG = np.loadtxt('/data/mnp34/scs_model-main/step_3/inputs/SPN.txt')
